...
def add_ubteacher_config(cfg):
    ...
    _C = cfg
    # EQL_v2
    _C.MODEL.ROI_HEADS.PRIOR_PROB = 0.001
    _C.MODEL.ROI_HEADS.EQLv2_GAMMA = 12
    _C.MODEL.ROI_HEADS.EQLv2_MU = 0.8
    _C.MODEL.ROI_HEADS.EQLv2_ALPHA = 4.0
    _C.MODEL.ROI_HEADS.Queue_size = 100
    _C.MODEL.ROI_HEADS.Alpha_list = (0.0, 0.0, 0.0)
